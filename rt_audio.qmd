...
Create a file `/etc/security/limits.d/licorice.conf` with the following contents, replacing <user> with your system username:
...
```bash
cd <folder-to-clone-demo>
git clone https://github.com/sabard/25_hope_workshop_code
```

2. Run demo

```bash
cd 25_hope_workshop_code
./examples/sine/run.sh
```
-->
